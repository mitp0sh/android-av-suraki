...
.field private static final q:Lbu;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/view/PagerTitleStrip;->q:Lbu;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v1, p0, v0}, Lbt;-><init>(Landroid/support/v4/view/PagerTitleStrip;B)V

    iput-object v1, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Lbt;
...
.method private static a(Landroid/widget/TextView;)V
    ...
    .prologue
    .line 108
    sget-object v0, Landroid/support/v4/view/PagerTitleStrip;->q:Lbu;

    invoke-interface {v0, p0}, Lbu;->a(Landroid/widget/TextView;)V
...
.method public a(IFZ)V
    ...
    invoke-virtual {v2}, Landroid/support/v4/view/ViewPager;->a()Lbq;
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v4/view/PagerTitleStrip;->a(ILbq;)V
    ...
    iget v2, v0, Landroid/support/v4/view/PagerTitleStrip;->e:I
    ...
    iget v4, v0, Landroid/support/v4/view/PagerTitleStrip;->e:I
...
.method public final a(Lbq;Lbq;)V
    ...
    .line 317
    iget-object v0, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Lbt;

    invoke-virtual {p1, v0}, Lbq;->b(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {p2, v0}, Lbq;->a(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {p0, v0, p2}, Landroid/support/v4/view/PagerTitleStrip;->a(ILbq;)V
...
.method protected onAttachedToWindow()V
    ...
    .line 251
    invoke-virtual {v0}, Landroid/support/v4/view/ViewPager;->a()Lbq;

    move-result-object v1

    .line 253
    iget-object v2, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Lbt;

    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->a(Lcu;)Lcu;

    .line 254
    iget-object v2, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Lbt;

    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->a(Lct;)V
    ...
    :goto_0
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/view/PagerTitleStrip;->a(Lbq;Lbq;)V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/view/ViewPager;->a(Lcu;)Lcu;

    .line 265
    iget-object v0, p0, Landroid/support/v4/view/PagerTitleStrip;->a:Landroid/support/v4/view/ViewPager;

    invoke-virtual {v0, v1}, Landroid/support/v4/view/ViewPager;->a(Lct;)V
