...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/acra/ErrorReporter;->a:Ljava/util/ArrayList;
    ...
    sput-object v0, Lorg/acra/ErrorReporter;->b:Lacj;
...
.method private static a(Landroid/content/Context;Ljava/lang/String;)Lacj;
    .locals 2
    ...
    .line 984
    :try_start_0
    invoke-virtual {v0, v1}, Lacj;->a(Ljava/io/InputStream;)V
    :try_end_0
...
.method private a(Ljava/lang/Throwable;Lorg/acra/ReportingInteractionMode;)Lacp;
    .locals 13
    ...
    .line 686
    iget-object p2, p0, Lorg/acra/ErrorReporter;->i:Lorg/acra/ReportingInteractionMode;
    ...
    invoke-direct {v0, p0}, Lacn;-><init>(Lorg/acra/ErrorReporter;)V

    invoke-virtual {v0}, Lacn;->start()V

    .line 722
    :cond_2
    sget-object v4, Lorg/acra/ErrorReporter;->g:Landroid/content/Context;
    ...
    invoke-interface {v5}, Lacr;->w()[Lacq;
    ...
    invoke-interface {v5}, Lacr;->x()Ljava/lang/String;
    ...
    :cond_3
    sget-object v0, Lorg/acra/ACRA;->DEFAULT_REPORT_FIELDS:[Lacq;
    ...
    sget-object v0, Lorg/acra/ErrorReporter;->b:Lacj;

    sget-object v7, Lacq;->a:Lacq;
    ...
    invoke-virtual {v0, v7, v8}, Lacj;->put(Ljava/lang/Enum;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_5
    sget-object v0, Lacq;->u:Lacq;
    ...
    sget-object v7, Lacq;->u:Lacq;

    invoke-static {}, Lc;->v()Ljava/lang/String;
    ...
    sget-object v8, Lacq;->w:Lacq;

    const/4 v9, 0x0

    invoke-static {v9}, Lc;->j(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v8, v9}, Lacj;->put(Ljava/lang/Enum;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_7
    sget-object v0, Lacq;->x:Lacq;
    ...
    sget-object v8, Lacq;->v:Lacq;

    sget-object v9, Lorg/acra/ErrorReporter;->g:Landroid/content/Context;

    invoke-static {}, Lorg/acra/ACRA;->getConfig()Lacr;

    move-result-object v10

    invoke-interface {v10}, Lacr;->r()[Ljava/lang/String;

    move-result-object v10

    invoke-static {v9, v10}, Lacm;->a(Landroid/content/Context;[Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v8, Lorg/acra/ErrorReporter;->b:Lacj;

    sget-object v9, Lacq;->A:Lacq;

    invoke-virtual {v8, v9, v0}, Lacj;->put(Ljava/lang/Enum;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v8, Lacq;->B:Lacq;

    sget-object v9, Lorg/acra/ErrorReporter;->g:Landroid/content/Context;

    invoke-static {v9}, Ladb;->a(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget-object v8, Lacq;->o:Lacq;

    iget-object v9, p0, Lorg/acra/ErrorReporter;->h:Ljava/lang/String;

    invoke-virtual {v0, v8, v9}, Lacj;->put(Ljava/lang/Enum;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_d
    sget-object v0, Lacq;->p:Lacq;
    ...
    sget-object v9, Lacq;->p:Lacq;

    invoke-static {v0}, Laci;->a(Landroid/content/res/Configuration;)Ljava/lang/String;
    ...
    sget-object v7, Lorg/acra/ErrorReporter;->b:Lacj;
    ...
    invoke-virtual {v7, v8, v9}, Lacj;->put(Ljava/lang/Enum;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_f
    sget-object v7, Lacq;->c:Lacq;
    ...
    :goto_3
    invoke-virtual {v7, v8, v0}, Lacj;->put(Ljava/lang/Enum;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v7, Lacq;->h:Lacq;

    const-class v8, Landroid/os/Build;

    invoke-static {v8}, Lc;->a(Ljava/lang/Class;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v7, v6}, Lacj;->put(Ljava/lang/Enum;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v6, Lacq;->D:Lacq;

    invoke-static {v4}, Lc;->i(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v0, v6, v4}, Lacj;->put(Ljava/lang/Enum;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v4, Lacq;->E:Lacq;

    const-class v6, Landroid/os/Environment;

    invoke-static {v6}, Lc;->b(Ljava/lang/Class;)Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v0, v4, v6}, Lacj;->put(Ljava/lang/Enum;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v4, Lacq;->F:Lacq;

    sget-object v6, Lorg/acra/ErrorReporter;->g:Landroid/content/Context;

    invoke-static {v6}, Lc;->j(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget-object v4, Lacq;->G:Lacq;

    sget-object v6, Lorg/acra/ErrorReporter;->g:Landroid/content/Context;

    invoke-static {v6}, Lc;->k(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget-object v4, Lacq;->H:Lacq;

    sget-object v5, Lorg/acra/ErrorReporter;->g:Landroid/content/Context;

    invoke-static {v5}, Lc;->l(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v0, v4, v5}, Lacj;->put(Ljava/lang/Enum;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
    ...
    sget-object v0, Lorg/acra/ACRA;->DEFAULT_MAIL_REPORT_FIELDS:[Lacq;
    ...
    .line 740
    invoke-static {v1, v1}, Lorg/acra/ErrorReporter;->a(Ljava/lang/String;Lacj;)Ljava/lang/String;

    move-result-object v0

    .line 743
    sget-object v4, Lorg/acra/ErrorReporter;->b:Lacj;

    sget-object v5, Lacq;->z:Lacq;

    invoke-virtual {v4, v5}, Lacj;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    .line 744
    sget-object v4, Lorg/acra/ErrorReporter;->b:Lacj;

    sget-object v5, Lacq;->r:Lacq;
    ...
    invoke-direct {v0, p0, v2}, Lacp;-><init>(Lorg/acra/ErrorReporter;Z)V
...
.method private static a(Ljava/lang/String;Lacj;)Ljava/lang/String;
    .locals 4
    ...
    .line 880
    sget-object p1, Lorg/acra/ErrorReporter;->b:Lacj;
    ...
    .line 886
    sget-object v2, Lacq;->z:Lacq;

    invoke-virtual {p1, v2}, Lacj;->a(Lacq;)Ljava/lang/String;
    ...
    sget-object v0, Lorg/acra/ErrorReporter;->d:Ljava/lang/String;
    ...
    .line 889
    :goto_1
    sget-object v1, Lorg/acra/ErrorReporter;->g:Landroid/content/Context;
    ...
    invoke-virtual {p1, v1, v2}, Lacj;->a(Ljava/io/OutputStream;Ljava/lang/String;)V
    :try_end_1
...
.method private static a(Lacj;)V
    .locals 6
    ...
    .line 848
    sget-object v1, Lorg/acra/ErrorReporter;->a:Ljava/util/ArrayList;
    ...
    .line 850
    :try_start_0
    invoke-interface {v0, p0}, Lacw;->a(Lacj;)V
    :try_end_0
    .catch Lacx; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static a(Lacw;)V
    .locals 1

    .prologue
    .line 1224
    sget-object v0, Lorg/acra/ErrorReporter;->a:Ljava/util/ArrayList;
...
.method public static synthetic a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v1, Lacq;->r:Lacq;

    invoke-virtual {v0, v1, p2}, Lacj;->put(Ljava/lang/Enum;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_0
    invoke-virtual {v0, v1, p3}, Lacj;->put(Ljava/lang/Enum;Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {p1, v0}, Lorg/acra/ErrorReporter;->a(Ljava/lang/String;Lacj;)Ljava/lang/String;
...
.method public static a(Landroid/text/format/Time;)V
    ...
    invoke-virtual {v0, v1, v2}, Lacj;->put(Ljava/lang/Enum;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static a(Ljava/lang/String;)V
    ...
    .prologue
    .line 807
    sget-object v0, Lorg/acra/ErrorReporter;->g:Landroid/content/Context;
    ...
    .line 813
    invoke-interface {v1}, Lacr;->j()I

    move-result v2

    .line 815
    sget-object v3, Lorg/acra/ErrorReporter;->g:Landroid/content/Context;

    invoke-interface {v1}, Lacr;->l()I
    ...
    .line 819
    sget-object v2, Lorg/acra/ErrorReporter;->g:Landroid/content/Context;

    invoke-interface {v1}, Lacr;->m()I
...
.method private h()[Ljava/lang/String;
    ...
    invoke-direct {v1, p0}, Laco;-><init>(Lorg/acra/ErrorReporter;)V
...
.method public final a(Landroid/content/Context;)V
    ...
    .line 361
    sput-object p1, Lorg/acra/ErrorReporter;->g:Landroid/content/Context;
...
.method public final declared-synchronized a(Landroid/content/Context;Z)V
    ...
    .line 959
    :try_start_1
    invoke-static {p1, v4}, Lorg/acra/ErrorReporter;->a(Landroid/content/Context;Ljava/lang/String;)Lacj;

    move-result-object v5

    .line 960
    invoke-static {v5}, Lorg/acra/ErrorReporter;->a(Lacj;)V
    ...
    .catch Lacx; {:try_start_1 .. :try_end_1} :catch_2
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public final c()V
    ...
    .line 1018
    :goto_1
    iget-object v4, p0, Lorg/acra/ErrorReporter;->i:Lorg/acra/ReportingInteractionMode;
    ...
    invoke-direct {v0, p0}, Lacp;-><init>(Lorg/acra/ErrorReporter;)V
    ...
    iget-object v0, v3, Lorg/acra/ErrorReporter;->i:Lorg/acra/ReportingInteractionMode;
    ...
    :goto_3
    invoke-direct {v3, v1, v2, v0}, Lorg/acra/ErrorReporter;->a(ZZI)V
    ...
    sget-object v2, Lorg/acra/ErrorReporter;->d:Ljava/lang/String;
...
.method public uncaughtException(Ljava/lang/Thread;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v0, v1}, Lacj;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    .line 622
    iget-object v0, p0, Lorg/acra/ErrorReporter;->i:Lorg/acra/ReportingInteractionMode;

    invoke-direct {p0, p2, v0}, Lorg/acra/ErrorReporter;->a(Ljava/lang/Throwable;Lorg/acra/ReportingInteractionMode;)Lacp;
    ...
    .line 634
    :goto_1
    invoke-virtual {v0}, Lacp;->isAlive()Z
